...
#### d)
total = df.groupby("State")["Outcome"].count()
success_total = df[df["Outcome"] == "Success"].groupby("State")["Outcome"].count()
success_state = (success_total / total * 100).sort_values(ascending=False)
